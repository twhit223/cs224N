...
class GlassdoorModel(normal_model):
    """
    ...
    def add_prediction_op(self):
        ...
        W1 = tf.get_variable("W1", shape = (self.config.n_window_features * self.config.embed_size, self.config.hidden_size1), initializer = tf.contrib.layers.xavier_initializer())
        W2 = tf.get_variable("W1", shape = (self.config.hidden_size1, self.config.hidden_size2), initializer = tf.contrib.layers.xavier_initializer())
